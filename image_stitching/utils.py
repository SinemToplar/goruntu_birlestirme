...
def forward(query_photo, train_photo):
    ...
    _, query_photo_gray = image_stitching.give_gray(query_photo)  # sol görsel
    _, train_photo_gray = image_stitching.give_gray(train_photo)  # sağ görsel
    ...
    if M is None:
        return "Görüntü birleştirme başarısız."
...
if __name__ == "__main__":
    try:
        ...
        print("En az iki kaynak görüntü gerekli.")
